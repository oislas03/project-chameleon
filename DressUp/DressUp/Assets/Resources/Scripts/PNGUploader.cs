...
public class PNGUploader : MonoBehaviour
{
    ...
    public GameObject infoGuardado;
    ...
    public void capturarImagen() {
         ...
         opciones = GameObject.Find("PanelOpciones");
         principal = GameObject.Find("PanelPrincipal");
    ...
    public void cerrarInfoGuardado()
    {
        infoGuardado.SetActive(false);
    ...
    public IEnumerator UploadPNG()
    {
        ...
        File.WriteAllBytes(Application.dataPath + "/StreamingAssets/sample.png" , bytes);

        //reponemos los botones
        botones.SetActive(true);
        opciones.SetActive(true);
        principal.SetActive(true);
        infoGuardado.SetActive(true);
